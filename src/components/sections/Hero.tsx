    ...
    >
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-6xl items-center gap-10 lg:grid-cols-12 lg:gap-12">
        ...
        <div className="lg:col-span-8 text-center lg:text-left">
          <div
            className="mb-6 inline-flex items-center gap-2 rounded-full border border-border bg-muted/50 px-4 py-1.5 text-xs font-medium text-muted-foreground backdrop-blur-md animate-fade-in"
          ...
          <p
            className="mx-auto mt-6 max-w-xl text-lg text-muted-foreground sm:text-xl animate-fade-up lg:mx-0"
          ...
          <div
            className="mt-6 flex items-center justify-center gap-2 font-mono text-sm text-primary animate-fade-up lg:justify-start"
          ...
          <div
            className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row animate-fade-up lg:justify-start"
          ...
          {/* Stats */}
          <div
            className="mt-12 grid grid-cols-2 gap-3 sm:grid-cols-4 animate-fade-up"
        ...
        {/* Right — portrait */}
        <div
          className="lg:col-span-4 flex justify-center lg:justify-end animate-fade-up"
          style={{ animationDelay: "0.3s" }}
        >
          <div className="relative w-full max-w-[260px] sm:max-w-[300px]">
            <div className="absolute -inset-4 rounded-full bg-gradient-to-br from-primary/40 to-secondary/40 blur-2xl animate-pulse-glow" />
            <div className="glass-card relative aspect-square overflow-hidden rounded-full p-1">
              <div className="relative h-full w-full overflow-hidden rounded-full">
                <img
                  src={portrait}
                  alt="Bonam Maruthi Anushka"
